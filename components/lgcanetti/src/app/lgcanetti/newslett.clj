...
(defn newslett-page []
  [:div
     ...
     [:dl
      ...
      [:div
       ...
       [:dt
        ...
        "Weekly articles"]
       [:dd
        {:class "mt-2 text-base/7 text-gray-400"}
      ...
      [:div
       ...
       [:dt {:class "mt-4 text-base font-semibold text-white"} "No spam"]
       [:dd
        {:class "mt-2 text-base/7 text-gray-400"}
   ...
   [:div
    ...
    [:div
     {:class
      "aspect-1155/678 w-[72.1875rem] bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30",
      :style
